...
namespace CodingWikiWeb.DataAccess.Migrations
{
    ...
    [Migration("20230507020830_addManyToManyRelationFluent_MappingTable_Book_Author")]
    partial class addManyToManyRelationFluent_MappingTable_Book_Author
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CodingWikiWeb.Model.Fluent_BookAuthorMap", b =>
                {
                    b.Property<int>("Author_Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CodingWikiWeb.Model.Fluent_Book", b =>
                {
                    b.HasOne("CodingWikiWeb.Model.Fluent_Publisher", "Publishers")
                        .WithMany("Books")
                        .HasForeignKey("Publisher_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("CodingWikiWeb.Model.Fluent_BookAuthorMap", b =>
                {
                    b.HasOne("CodingWikiWeb.Model.Fluent_Author", "Author")
                        .WithMany("Fluent_BookAuthorMap")
                        .HasForeignKey("Author_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CodingWikiWeb.Model.Fluent_Book", "Book")
                        .WithMany("Fluent_BookAuthorMap")
                        .HasForeignKey("Book_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
